...
货架要的是可审核、可定价、可跟账号走、可对家长交代的商品。模组河要的是改物理、改法律、每个大版本自己续命、署名在论坛 ID 上。Marketplace 上线时的门槛写得很清楚：启动阵容是有名有姓的工作室，后续投稿需要注册过的公司。[^mp-announce] 这不是「社区变现」的中性接口。这是把第三条河——换皮、换地图、换皮肤——收进客厅，把第一条河留在院子里。附加包可以改行为和外观，仍然过审核；Forge 那种新动词，没有对应的货架 SKU。
...
可被证伪的说法是：Marketplace 只是模组文化的移动版，审核只是为了安全。只要附加包仍不能稳定地提供工业电网那种新陈代谢，而皮肤包可以，审核的选择就写在货架上：安全是理由，作者权是结构。第 11 章会写灰色经济；这里先钉死：两种 UGC 不能兑换。
...
| 联机 | 任意 IP、社区内核 | 账号、合作服、主机限制填 IP | 「服务器即新游戏」被收编进浏览器 |
