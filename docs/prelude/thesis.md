...
**"画面过时了。"** 如果画面是关键，高清材质和光追整合包早就该把它救回来；而实际情况相反——越写实的整合包，社区反而越小。这条正好戳中我自己：我要做的就是写实版。所以它不是一个可以糊过去的反驳，而是我必须正面承担的风险，放在第四卷[《写实化的代价》](../aether/realism)里处理，不在这里预支答案。
...
- **准连通性是个 bug。** 活塞会响应它上方一格的信号。它从没被修，因为修了会毁掉几十万个已建成的装置。一个实现缺陷变成了社区的共有资产，同时也变成了一块动不了的技术债。
...
::: info 亲历 · 高中那个平滑版
我用 Marching Cubes 做过一个没有棱角的 Minecraft。地形连续起伏，跑起来很漂亮，然后我发现自己没法在里面盖房子——不是技术上不行，是心理上不行。你无法一眼判断两个位置差多少，无法把一个结构记住并复述给别人，也无法照着视频复刻。我删掉的不是画面风格，是第一节"可读"。

这一类框是我的第一手经历：开服、写插件、复刻引擎、写物理。它是这本书的可信度来源，但也是它偏见的来源——我是当事人，不是观察者。
:::
